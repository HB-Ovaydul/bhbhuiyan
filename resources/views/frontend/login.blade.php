							...
							<div class="account-content">
								<div class="row align-items-center justify-content-center">
									<div class="col-md-7 col-lg-6 login-left">
										<img src="frontend/assets/img/login-banner.png" class="img-fluid" alt="Doccure Login">	
									</div>
									<div class="col-md-12 col-lg-6 login-right">
										...
										<form action="{{ route('patient.login') }}" method="POST">
											...
											<div class="text-center dont-have">Don’t have an account? <a href="{{ route('patient.rag.page') }}">Register</a></div>
										</form>
									</div>
								</div>
							</div>
